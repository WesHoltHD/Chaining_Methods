...
class User:
    ...
    def enroll(self):
        ...
        #? NOTE: Returning "self" in order to be able to actually ChainMethods, If You Do Not Return Self On Functions That Require An Answer It Will Force An ERROR
